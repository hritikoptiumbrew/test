...
class SinglePageToMultiPageDataTransfer extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'SinglePageToMultiPageDataTransfer';
     ...
     * @var string
     */
    protected $description = 'Convert single page templates to multi page templates from old sub category to new sub category.';
    ...
    {
        try {
            $old_sub_category = config('constant.SINGLE_PAGE_SUB_CATEGORY_ID');
