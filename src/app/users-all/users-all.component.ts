...
export class UsersAllComponent implements OnInit {
  ...
  constructor(public route: ActivatedRoute, private dataService: DataService, private router: Router, private viewContainerRef: ViewContainerRef, public dialog: MdDialog) {
    this.loading = this.dialog.open(LoadingComponent);
    this.searchArray = [
      { 'searchTagValue': '', 'searchTagName': 'Search Type' },
      { 'searchTagValue': 'device_platform', 'searchTagName': 'Platform' },
      { 'searchTagValue': 'device_model_name', 'searchTagName': 'Model Name' },
      { 'searchTagValue': 'device_country_code', 'searchTagName': 'Country Code' },
      { 'searchTagValue': 'device_registration_date', 'searchTagName': 'Registration Time' }
    ];
  ...
  ngOnInit() {
    ...
    this.sub = this.route.params
      .subscribe(params => {
        ...
        this.getAllUsers(this.sub_category_id, this.currentPage, this.itemsPerPage, this.sortByTagName, this.order_type_val);
      });
  }
  ...
  getAllUsers(sub_category_id, currentPage, itemsPerPage, sortByTagName, order_type_val) {
    this.token = localStorage.getItem('photoArtsAdminToken');
    this.dataService.postData('getAllUser',
      {
  ...
  searchData(searchQuery, searchTag) {
    ...
    if (typeof searchQuery == "undefined" || searchQuery == "" || searchQuery == null) {
      ...
      this.loading = this.dialog.open(LoadingComponent);
      this.dataService.postData('searchUser', {
