    ...
    $(document).ready(function () {
      ...
      if (that.data) {
        ...
        if (that.platform == 'android') {
          $('#summernote').summernote('code', '<style>body{padding: 10px;} p{margin: 0 !important;} table { border: none;margin: 0 !important;width: 100%;} .sttc-button {font-family: -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 1rem; font-weight: 500; border: none; border-radius: 4px; box-shadow: none; color: #ffffff; cursor: pointer; display: inline-block; margin: 0px; padding: 8px 18px; text-decoration: none; background-color: #ffcd00; overflow-wrap: break-word; user-select:none !important;}.sttc-button:hover, .sttc-button:focus{ background-color: #d9ae00;}</style><script>function OpenTemplate(templateID) { Android.moveToNextScreen(templateID); } function searchTemplate(searchTag) { Android.goToSearchScreen(searchTag);} </script>');
        }
        else {
          $('#summernote').summernote('code', '<style>body{padding: 10px;} p{margin: 0 !important;} table { border: none;margin: 0 !important;width: 100%;} .sttc-button {font-family: -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 1rem; font-weight: 500; border: none; border-radius: 4px; box-shadow: none; color: #ffffff; cursor: pointer; display: inline-block; margin: 0px; padding: 8px 18px; text-decoration: none; background-color: #ffcd00; overflow-wrap: break-word; user-select:none !important;}.sttc-button:hover, .sttc-button:focus{ background-color: #d9ae00;}</style><script> function OpenTemplate(templateID) { window.location = "videoadking://?templateID="+ templateID } function searchTemplate(searchTag) { window.location = "videoadking://?searchTag="+ searchTag} </script>');
        }
      }
    });
  }
