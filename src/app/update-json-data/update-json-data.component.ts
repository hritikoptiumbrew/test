...
export class UpdateJsonDataComponent implements OnInit {
  ...
  constructor(public dialogRef: MdDialogRef<UpdateJsonDataComponent>, private dataService: DataService, private router: Router, private renderer: Renderer, public dialog: MdDialog) {
